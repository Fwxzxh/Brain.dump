#+title: Curso de visualización de datos para Business Inteligence

*Recursos:* [[https://datavizcatalogue.com/ES/index.html][Catalogue Data Visualization]]

* Fundamentos de la visualizaciónn de datos
...
- Estamos en la era de información, así­ que haymás datos que nunca.
...
- Nuestro papel ante la audiencia es evitar el sesgo y el bias en la visualizaciÃ³n.
...
- Si no se alcanza a ver las diferencias entre categorias, procurar usar otro tipo de gráfica.
...
** Gráfica de Burbujas
- El tamaño de la burbuja nos puede mostrar una variable más para la vizualizacion.
- Pudeden ser como una gráfica de dispersión o solo usar el tamaño de la burbuja para denotar una cantidad.
...
- Los mapas pueden ser una representación sensilla y no tan precisa.
...
- [[google:Mapas+de+Isolíneas&sourceid=chrome&ie=UTF-8][Ejemplos]]

*** Mapas Coroplágticos
- Son mapas que representan con color los lugares donde ocurrieron ciertos sucesos.
- [[google:Mapas+Coropléticos&sourceid=chrome&ie=UTF-8][Ejemplo]]

*** Mapas de diagramas
- Estos pueden considerarse mapas combinados, ya que por lo general utilizan el color para hacer una distinción
  variable y alguna otra visualización.
- Son utilizados en estadística, geografía, reportes económicos, salud, etc.

*** Mapas Anamárfico
- Utilizan distintos tipos de figuras geometrícas para identificar sucesos en determinadas ubicaciones.
...
- Debemos estar al pendiente de la calibraciónn de la paleta de colores.
